...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { email: @admin_user.email, password: @admin_user.password, password_confirmation: @admin_user.password_confirmation, roles: @admin_user.roles }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { email: @admin_user.email, password: @admin_user.password, password_confirmation: @admin_user.password_confirmation, roles: @admin_user.roles }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
